    ...
    return (
        ...
        <div className='bg-hero-pattern fixed bg-cover min-w-full min-h-full z-0'>
            ...
            <div className='h-screen relative'>
                <div className='flex w-full fixed justify-center z-50'>
                ...
                <div className='md:top-16 text-white absolute flex flex-col justify-center inset-0 items-center tracking-wide xs:tracking-wider'>
                    ...
                    <div className='md:hidden absolute container bottom-0 cursor-default'>
            ...
            <div className='relative bg-white pl-2 pr-2 xs:pl-3 xs:pr-3 md:pl-6 md:pr-5 xl:pl-16 xl:pr-14 pb-2 md:pb-4 '>                        
                <Feedback />
            </div>
